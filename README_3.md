...
|------|-------------|---------|
| Captain | Diplomacy | Command Bridge + Sensor Station |
| Engineer | Computers | Reactor Status + Navigation Bridge |
| Gunner | Acrobatics | Gunnery Deck + Ordnance Deck |
...
Firing consumes the target's lock. After the Gunner fires, the Captain rolls a Battle Damage Assessment — the roll determines how much of the lock is retained and grants one fire correction:
...
The Engineer manages the reactor, distributes **Power Cores**, manages heat and internal fire, and controls ship movement. Helm allocation uses the Computers skill.
...
The Engineer also steers the ship using the **Helm Control** panel, with a live canvas overlay showing the projected path, turning arc, and minimum-move zone. Helm allocation rolls use **Computers**.

Roll Computers once per round. Allocate Points to:
